...
public class SoftmaxTemp extends GibbsSampling {
	...
	public SoftmaxTemp(int[][] transactions, int nbItems, String g_name, int[] consequent) {
		super(transactions, nbItems, consequent);

		this.g_name = g_name;
		this.temp = 0.0;
	}

	public SoftmaxTemp(int[][] transactions, int nbItems, String g_name, double temp, int[] consequent) {
		super(transactions, nbItems, consequent);
	...
	protected double g_function(BinaryRule J) {
