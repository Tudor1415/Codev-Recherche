...
public class SoftmaxTemp extends GibbsSampling {
	...
	public SoftmaxTemp(int nbSamples, int[][] transactions, int nbItems, String g_name) {
		super(nbSamples, transactions, nbItems);
		
		this.g_name = g_name;
		this.temp = 0.0;
	}
	
	public SoftmaxTemp(int nbSamples, int[][] transactions, int nbItems, String g_name, double temp) {
		super(nbSamples, transactions, nbItems);
